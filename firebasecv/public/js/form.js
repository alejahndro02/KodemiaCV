...
// //arrays de almacenaje de datos de experiencia 
// var experienceArray = [];
// $('#btn-experience').click(() =>{
// 	// console.log('click experience')
// 	let newExperience = {
// 		company: $("#f-company").val(),
// 		role: $("#f-role").val(),
// 		description: $("#f-descriptionRole").val(),
...
// });
// 	// const printOption=(wrapper,text)=>{
// 	// 	console.log(text);
// 	// 	$(wrapper).append(
// 	// 	`<div class="all-tag p-2 mr-2 mt-2">${text}</div>`
// 	// 	)
// 	// }
